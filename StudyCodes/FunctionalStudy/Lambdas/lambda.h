...
namespace yche {
    //  Refer to vczh
    //  http://github.com/vczh/vczh_toys/CppRecursiveLambda/
...
//    std::function<typename PartialLambdaTypeRetriver<decltype(&TLambda::operator())>::FunctionType> Y(
//            TLambda partialLambda) {
