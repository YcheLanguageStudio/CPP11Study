...
int main() {
    {
        // Create the graph, and specify that we will use std::string to store the first name's.
        using MyGraphType=adjacency_list<vecS, vecS, directedS, property<vertex_first_name_t, std::string> >;
